  ...
  <div class="page-container">
    ...
    <div class="sidebar p-4">
      ...
      <div class="upload-section glass-panel p-4 rounded-lg mb-6">
        ...
        <input type="file" @change="onFileChange" class="form-input text-sm mb-2" />
        <button @click="uploadFile" class="btn btn-primary w-full" :disabled="!selectedFile || isUploading">
